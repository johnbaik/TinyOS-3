...
typedef struct p_t_control_block {
  ...
  int argl;               /**< The main thread's argument length */
  void* args;             /**< The main thread's argument string */
  CondVar ptcb_cv;     /**< Condition variable for @c WaitChild */
  int ref_count;
  detach is_detach;
  Thread_state state;
} PTCB;
